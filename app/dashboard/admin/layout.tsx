...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-8 py-16 sm:py-20">
      ...
      <nav className="mt-8 flex flex-wrap gap-6 border-b border-navy/15 pb-4 text-sm font-semibold uppercase tracking-wide">
        <a href="/dashboard/admin" className="text-navy hover:text-blue">
          Tài khoản
        </a>
        <a href="/dashboard/admin/permissions" className="text-navy hover:text-blue">
          Quyền tài liệu
        </a>
      </nav>
