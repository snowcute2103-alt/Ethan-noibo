        ...
        <section className="rule-laptop-section">
          ...
          <div className="rule-laptop-zoom">
            <div className="rule-laptop-scene">
              <div className="rule-laptop-rock">
                <div className="rule-laptop-spin">
                  <div className="rule-laptop-shadow">
                    <div className="rule-laptop-jump">
                      <div className="rule-laptop-flip">
                        <div className="rule-laptop-book">
                          <div className="rule-laptop-shell rule-laptop-shell--top">
                            <img
                              className="rule-laptop-screen-face"
                              src="/images/brand/logo-hires.png"
                              alt=""
                              aria-hidden="true"
                            />
                            <div className="rule-laptop-cuboid">
                              <div className="rule-laptop-cuboid-side" />
                              <div className="rule-laptop-cuboid-side" />
                              <div className="rule-laptop-cuboid-side" />
                              <div className="rule-laptop-cuboid-side" />
                              <div className="rule-laptop-cuboid-side">
                                <img
                                  className="rule-laptop-shell-face"
                                  src="/images/brand/logo-hires.png"
                                  alt=""
                                  aria-hidden="true"
                                />
                          ...
                          <div className="rule-laptop-shell rule-laptop-shell--bottom">
                            <svg
                              className="rule-laptop-keyboard"
